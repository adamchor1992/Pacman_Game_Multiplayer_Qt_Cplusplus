...
%MINGW32_MAKE_PATH%\mingw32-make.exe -f %REPO_PATH%/build-Pacman_Server-Desktop_Qt_5_15_0_MinGW_64_bit-Release/Makefile qmake_all
%MINGW32_MAKE_PATH%\mingw32-make.exe -f Makefile.Release
...
%MINGW32_MAKE_PATH%\mingw32-make.exe -f %REPO_PATH%/build-Pacman_Client-Desktop_Qt_5_15_0_MinGW_64_bit-Release/Makefile qmake_all
%MINGW32_MAKE_PATH%\mingw32-make.exe -f Makefile.Release